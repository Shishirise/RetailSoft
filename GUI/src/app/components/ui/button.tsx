 ...
 * Defines the different visual styles and sizes for buttons
...
/**
 * Button component
 * Versatile button with multiple style variants and sizes
 * 
 * @param variant - Visual style: default, destructive, outline, secondary, ghost, link
 * @param size - Button size: default, sm, lg, icon
 * @param asChild - If true, merges props into child element instead of rendering a button
 */
function Button({
  className,
  variant,
